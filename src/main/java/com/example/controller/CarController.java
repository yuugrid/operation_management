...
public class CarController {
	...
	@GetMapping("/index")
	public String index(Model model, @ModelAttribute CarForm carForm, @RequestParam(value = "carId", required = false) Integer id, @RequestParam(value = "carName", required = false) String name, @RequestParam(value = "carPassengers", required = false) Integer passengers) {
